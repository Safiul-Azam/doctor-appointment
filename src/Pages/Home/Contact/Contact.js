...
const Contact = () => {
    return (
    <div style={{background:`url(${appointment})`}} className='p-16 mt-2 px-12'>
            <h4 className='text-center text-xl font-bold mb-3 text-secondary '>contact us</h4>
            <h3 className='text-center text-2xl lg:text-4xl mb-10 text-white'>Stay connected with us</h3>
            <div className='w-full md:w-2/4 lg:w-6/12 mx-auto'>
                ...
                <textarea className='w-full border block mb-2 p-2 rounded' name="message" placeholder='Your message' cols="10" rows="5"></textarea>
